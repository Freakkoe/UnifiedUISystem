...
{
    // Represents the Razor Page for viewing the details of an EmployeeInfo record.
    public class DetailsModel : PageModel
    {
        ...
        public Models.EmployeeInfo EmployeeInfo { get; set; } = default!; // The EmployeeInfo model object that will display the details.

        // Handles the GET request for the Details page.
        // Retrieves the EmployeeInfo record by its ID to display the details.
